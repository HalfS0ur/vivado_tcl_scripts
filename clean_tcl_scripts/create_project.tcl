...
#file mkdir $ROOT_PATH/src/REPO_LAB/ejercicioN ;
#file mkdir $ROOT_PATH/src/REPO_LAB/ejercicioN/design ;
file mkdir $ROOT_PATH/src/REPO_LAB/ejercicioN/testbench ;
file mkdir $ROOT_PATH/src/REPO_LAB/ejercicioN/constraints ;
file mkdir $ROOT_PATH/src/REPO_LAB/ejercicioN/ips ;
...
# Design files
add_files -norecurse -fileset sources_1 $ROOT_PATH/src/REPO_LAB/ejercicioN
# IP files - Need to be added one by one
# add_files -norecurse -fileset sources_1 $ROOT_PATH/src/REPO_LAB/ejercicioN/ips/clk_wiz_0/clk_wiz_0.xci
# Testbench files
add_files -norecurse -fileset sim_1 $ROOT_PATH/src/REPO_LAB/ejercicioN/testbench/
# Constraint files
add_files -norecurse -fileset constrs_1 $ROOT_PATH/src/REPO_LAB/ejercicioN/constraints/

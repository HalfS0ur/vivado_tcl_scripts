...
file mkdir $ROOT_PATH/src/ejemplo1 ;
file mkdir $ROOT_PATH/src/ejemplo1/design ;
file mkdir $ROOT_PATH/src/ejemplo1/testbench ;
file mkdir $ROOT_PATH/src/ejemplo1/constraints ;
file mkdir $ROOT_PATH/src/ejemplo1/ips ;
...
# Design files
add_files -norecurse -fileset sources_1 $ROOT_PATH/src/ejemplo1/design
# IP files - Need to be added one by one
# add_files -norecurse -fileset sources_1 $ROOT_PATH/src/ips/clk_wiz_0/clk_wiz_0.xci
# Testbench files
add_files -norecurse -fileset sim_1 $ROOT_PATH/src/ejemplo1/testbench
# Constraint files
add_files -norecurse -fileset constrs_1 $ROOT_PATH/src/ejemplo1/constraints/
